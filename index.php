         ...
         <div class="row people d-flex justify-content-center">
            ...
            $daftar_pic = [
              [
                ...
                'gambar' => './assets/img/pic/REYHAN-FAUZAN-ADZIMA-03.jpg'
              ],
              [
                ...
                'gambar' => './assets/img/pic/RIZKI-NOOR-AINI-04.jpg'
              ],
              [
                ...
                'gambar' => './assets/img/pic/NISA-ANGGUN-SPICA-02.jpg',
              ],
              [
                ...
                'gambar' => './assets/img/pic/NI-PUTU-RISKA-VALENTINI-09.jpg',
              ],
              [
                ...
                'gambar' => './assets/img/pic/DEWI-RIZKY-KUSUMONEGORO-05.jpg',
              ],
              [
                ...
                'gambar' => './assets/img/pic/LULUK-FATIKHATUN-NOFIKA-06.jpg',
              ],
              [
                ...
                'gambar' => './assets/img/pic/JODI-BAIHAQI-GUMELAR-07.jpg',
              ],
              [
                'nama' => 'Steven Ferico',
                ...
                'gambar' => './assets/img/pic/STEVEN-FERICO-10.jpg',
              ],
              [
                ...
                'gambar' => './assets/img/pic/SYIFA-ALFIA-RAHMI-01.jpg',
              ],
              [
